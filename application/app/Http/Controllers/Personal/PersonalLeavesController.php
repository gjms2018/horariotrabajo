...
class PersonalLeavesController extends Controller
{
    ...
    public function requestL(Request $request) 
    {
        ...
        return redirect('personal/leaves/view')->with('success', trans("A leave request is submitted!"));
    }
    ...
    public function update(Request $request)
    {
        ...
        return redirect('personal/leaves/view')->with('success', trans("Update was successful!"));
    }
    ...
    public function delete($id, Request $request)
    {
        ...
        return redirect('personal/leaves/view')->with('success', trans("A leave is successfully deleted!"));
    }
