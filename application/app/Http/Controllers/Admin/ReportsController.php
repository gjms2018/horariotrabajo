...
class ReportsController extends Controller
{
	...
	public function orgProfile(Request $request) 
	{
		...
		$today = date('M, d Y');
		$ed = table::people()->join('company_data', 'people.id', '=', 'company_data.reference')->where('people.employmentstatus', 'Active')->get();
	...
	public function empBday(Request $request) 
	{
		...
		$today = date('M, d Y');
		$empBday = table::people()->join('company_data', 'people.id', '=', 'company_data.reference')->get();
