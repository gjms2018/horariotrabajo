...
class ProfileController extends Controller
{
	...
	public function clear(Request $request) 
	{
		...
		return redirect('employees')->with('success', trans("The employee is successfully removed!"));
	}
   	...
   	public function archive($id, Request $request)
    {
    	...
    	return redirect('employees')->with('success', trans("The employee is successfully archived!"));
   	}
    ...
    public function updatePerson(Request $request)
    {
    	...
    	return redirect('profile/edit/'.$id)->with('success', trans("Update was successful!"));
   	}
	...
	public function updateUser(Request $request) 
	{
		...
		return redirect('update-profile')->with('success', trans("Update was successful!"));
	}
	...
	public function updatePassword(Request $request) 
	{
		...
		{
			return redirect('update-password')->with('error', trans("The new passwords must match!"));
		}
		...
		if(Hash::check($c_password, $p)) 
		{
			...
			return redirect('update-password')->with('success', trans("Update was successful!"));
		} else {
			return redirect('update-password')->with('error', trans("Wrong credentials!"));
		}
	}
