...
class ImportsController extends Controller
{
	...
	function importCompany(Request $request) 
	{
		...
		if ($uploadedfile != null) 
		{
			...
			return redirect('fields/company')->with('error', trans("Invalid request! Please upload a csv file"));
		}
	}
	...
	function importDepartment(Request $request) 
	{
		...
		if ($uploadedfile != null) 
		{
			...
			return redirect('fields/department')->with('error', trans("Invalid request! Please upload a csv file"));
		}
	}
	...
	function importJobtitle(Request $request) 
	{
		...
		{ 
			...
			return redirect('fields/jobtitle')->with('error', trans("Invalid request! Please upload a csv file"));
		}
	}
	...
	function importLeavetypes(Request $request) 
	{
		...
		if($uploadedfile != null) 
		{
			...
			return redirect('fields/leavetype')->with('error', trans("Invalid request! Please upload a csv file"));
		}
	}
