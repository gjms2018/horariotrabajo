...
class UsersController extends Controller
{
    ...
    public function register(Request $request)
    {
        ...
        {
            return redirect('users')->with('error', trans("The passwords must match!"));
        }
        ...
        if($is_user_exist >= 1) 
        {
            return redirect('users')->with('error', trans("Are you sure? This user is registered!"));
        }
    	...
    	return redirect('/users')->with('success', trans("Successful registration!"));
    }
    ...
    public function delete($id, Request $request)
    {
        ...
        return redirect('users')->with('success', trans("A user account is successfully deleted!"));
    }
}
