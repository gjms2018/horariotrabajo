...
class AttendanceController extends Controller
{
    ...
    public function index() 
    {
        ...
        $dd = table::attendance()->orderBy('date', 'desc')->take(60)->get();
        $s = table::settings()->select('clock_comment', 'time_format')->first();
        $e = table::people()->get();
        $tf = table::settings()->value("time_format");
        $c = table::settings()->value("clock_comment");
        
        return view('admin.attendance', compact('dd', 's', 'e', 'tf', 'c'));
    }
    ...
    public function delete($id, Request $request)
    {
        ...
        return redirect('attendance')->with('success', trans("Attendance is successfully deleted!"));
    }
    ...
    public function update(Request $request)
    {
        ...
        return redirect('attendance')->with('success', trans("Update was successful!"));
    }
    ...
    public function addEntry(Request $request)
    {
        ...
        if ($request->ref == NULL) {
            return redirect('attendance')->with('error', trans("Invalid request!"));
        }
        ...
        if ($iprestriction != NULL) 
        {
            ...
            {
                return redirect('attendance')->with('error', trans("Invalid request! Your device it not registered"));
            }
        } 
        ...
        if($emp_id == null || $emp_idno == null) {
            return redirect('attendance')->with('error', trans("There is no employee with this ID!"));
        }
        ...
        if ($timeout == null) 
        {
            ...
            if ($has == 1) 
            {
                ...
                return redirect('attendance')->with('success', trans("Success! Attendance data is saved!"));
            }
        }
        ...
        if ($timeout != null && $timein != null) 
        {
            ...
            if ($has == 1) 
            {
                ...
                return redirect('attendance')->with('success', trans("Success! New attendance data is saved!"));
            }
        }
    }
