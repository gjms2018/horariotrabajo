...
class RolesController extends Controller
{
    ...
    public function add(Request $request) 
    {
    	...
    	return redirect('users/roles')->with('success', trans("Successful registration!"));
    }
    ...
    public function delete($id, Request $request) 
    {
        ...
        return redirect('users/roles')->with('success', trans("A user role is successfully deleted!"));
    }
    ...
    public function update(Request $request) 
    {
        ...
        return redirect('users/roles')->with('success', trans("Update was successful!"));
    }
