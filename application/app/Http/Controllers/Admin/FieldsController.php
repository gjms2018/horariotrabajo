...
class FieldsController extends Controller
{
    ...
    */
    ...
    public function addCompany(Request $request)
    {
      ...
      return redirect('fields/company')->with('success', trans("Successful registration!"));
    }
    ...
    public function deleteCompany($id, Request $request)
    {
      ...
      return redirect('fields/company')->with('success', trans("A company is successfully deleted!"));
    }
    ...
    */
    ...
    public function addDepartment(Request $request)
    {
      ...
      return redirect('fields/department')->with('success', trans("Successful registration!"));
    }
    ...
    public function deleteDepartment($id, Request $request)
    {
      ...
      return redirect('fields/department')->with('success', trans("A department is successfully deleted!"));
    }
    ...
    */
    ...
    public function addJobtitle(Request $request)
    {
      ...
      return redirect('fields/jobtitle')->with('success', trans("Successful registration!"));
    }
    ...
    public function deleteJobtitle($id, Request $request)
    {
      ...
      return redirect('fields/jobtitle')->with('success', trans("A job title is successfully deleted!"));
    }
    ...
    */
    ...
    public function addLeavetype(Request $request)
    {
      ...
      return redirect('fields/leavetype')->with('success', trans("Successful registration!"));
    }
    ...
    public function deleteLeavetype($id, Request $request)
    {
      ...
      return redirect('fields/leavetype')->with('success', trans("A leave type is successfully deleted!"));
    }
    ...
    */
    ...
    public function addLeaveGroups(Request $request) 
    {
      ...
      return redirect('fields/leavetype/leave-groups')->with('success', trans("Successful registration!"));
    }
    ...
    public function updateLeaveGroups(Request $request) 
    {
      ...
      return redirect('fields/leavetype/leave-groups')->with('success', trans("Update was successful!"));
    }
    ...
    public function deleteLeaveGroups($id,Request $request) 
    {
      ...
      return redirect('fields/leavetype/leave-groups')->with('success', trans("A leave group is successfully deleted!!"));
    }
} 