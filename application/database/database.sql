-- MySQL dump 10.13  Distrib 5.6.37 
--
...
INSERT INTO `company_data` VALUES (1,1,'','','','','001122','2020-02-01','2020-02-01','',NULL),(2,2,'','','','','001133','2020-02-01','2020-02-01','',NULL);
...
LOCK TABLES `form_company` WRITE;
/*!40000 ALTER TABLE `form_company` DISABLE KEYS */;
/*!40000 ALTER TABLE `form_company` ENABLE KEYS */;
UNLOCK TABLES;
...
DROP TABLE IF EXISTS `form_department`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
LOCK TABLES `form_department` WRITE;
/*!40000 ALTER TABLE `form_department` DISABLE KEYS */;
/*!40000 ALTER TABLE `form_department` ENABLE KEYS */;
UNLOCK TABLES;
...
DROP TABLE IF EXISTS `form_jobtitle`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
LOCK TABLES `form_jobtitle` WRITE;
/*!40000 ALTER TABLE `form_jobtitle` DISABLE KEYS */;
/*!40000 ALTER TABLE `form_jobtitle` ENABLE KEYS */;
UNLOCK TABLES;
...
DROP TABLE IF EXISTS `form_leavegroup`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
LOCK TABLES `form_leavegroup` WRITE;
/*!40000 ALTER TABLE `form_leavegroup` DISABLE KEYS */;
/*!40000 ALTER TABLE `form_leavegroup` ENABLE KEYS */;
UNLOCK TABLES;
...
DROP TABLE IF EXISTS `form_leavetype`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
LOCK TABLES `form_leavetype` WRITE;
/*!40000 ALTER TABLE `form_leavetype` DISABLE KEYS */;
/*!40000 ALTER TABLE `form_leavetype` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `people` VALUES (1,'MANAGER','','DEMO',NULL,'','manager@example.com','',NULL,NULL,NULL,'2020-01-03','','','','Active',NULL,''),(2,'DEMO','','EMPLOYEE',NULL,'','employee@example.com','',NULL,NULL,NULL,'2020-01-03','','','','Active',NULL,'');
...
DROP TABLE IF EXISTS `people_attendance`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
LOCK TABLES `people_attendance` WRITE;
/*!40000 ALTER TABLE `people_attendance` DISABLE KEYS */;
/*!40000 ALTER TABLE `people_attendance` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `report_views` VALUES (1,1,'','Employee List Report'),(2,2,'','Employee Attendance Report'),(3,3,'','Employee Leaves Report'),(4,4,'','Employee Schedule Report'),(5,5,'','Organizational Profile'),(6,6,'','User Accounts Report'),(7,7,'','Employee Birthdays');
