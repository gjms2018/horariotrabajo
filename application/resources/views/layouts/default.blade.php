                            ...
                            <li class="nav-item">
                                <div class="ui pointing link dropdown item" tabindex="0">
                                    ...
                                    <div class="menu" tabindex="-1">
                                      ...
                                      <a href="{{ url('lang/tr') }}" class="item"><i class="flag-icon flag-icon-tr"></i>Turkish</a>
                                    </div>
                              </div>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                               <div class="ui pointing link dropdown item" tabindex="0">
                                    ...
                                    <div class="menu" tabindex="-1">
                                      ...
                                      <a href="{{ url('personal/dashboard') }}" target="_blank" class="item"><i class="ui icon user lock"></i>{{ __('Switch to My Account') }}</a>
                                      <div class="divider"></div>
