@extends('layouts.personal')
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <h2 class="page-title">{{ __("My Attendance") }}</h2>
            </div>    
        </div>
        <div class="row">
            <div class="col-md-12">
                    ...
                    <form action="" method="get" accept-charset="utf-8" class="ui small form form-filter" id="filterform">
                        ...
                        <div class="inline two fields">
                            <div class="three wide field">
                                ...
                                <input id="datefrom" type="text" name="" value="" autocomplete="off" placeholder="Start Date" class="airdatepicker">
                                <i class="ui icon calendar alternate outline calendar-icon"></i>
                            </div>
                            <div class="two wide field">
                                <input id="dateto" type="text" name="" value="" autocomplete="off" placeholder="End Date" class="airdatepicker">
                                <i class="ui icon calendar alternate outline calendar-icon"></i>
                            </div>
